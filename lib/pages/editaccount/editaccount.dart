...
import 'package:TaxiApp/component/chooseuploadimage.dart';
import 'dart:io';
import 'package:TaxiApp/component/crud.dart';
import 'package:TaxiApp/component/preferences.dart';
    ...
    if (formstate.validate()) {
      ...
      if (file != null) {
        ...
        if (usersnew['status'] == "Success") {
          savePref(usersnew['username'], usersnew['email'], usersnew['phone'],
              usersnew['password']);
        }
      } else {
        if (loading == true) {
